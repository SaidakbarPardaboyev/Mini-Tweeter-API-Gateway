...
type TweetMedia struct {
	...
	MediaType     string                 `protobuf:"bytes,3,opt,name=media_type,json=mediaType,proto3" json:"media_type"`
...
type CreateTweetMediaRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	TweetMedia    *TweetMedia            `protobuf:"bytes,1,opt,name=TweetMedia,proto3" json:"TweetMedia"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetListTweetMediaRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	TweetId       string                 `protobuf:"bytes,1,opt,name=tweet_id,json=tweetId,proto3" json:"tweet_id"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type TweetMediaList struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	TweetMedias   []*TweetMedia          `protobuf:"bytes,1,rep,name=TweetMedias,proto3" json:"TweetMedias"`
