...
type Tweet struct {
	...
	Medias        []*TweetMedia          `protobuf:"bytes,4,rep,name=medias,proto3" json:"medias"`
...
type GetListTweetRequest struct {
	...
	Search        *string                `protobuf:"bytes,3,opt,name=search,proto3,oneof" json:"search"`               // Merged field for content
...
type TweetList struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Tweets        []*Tweet               `protobuf:"bytes,1,rep,name=Tweets,proto3" json:"Tweets"`
