...
type FollowRequest struct {
	...
	FollowerId    string                 `protobuf:"bytes,1,opt,name=follower_id,json=followerId,proto3" json:"follower_id"`
	FollowingId   string                 `protobuf:"bytes,2,opt,name=following_id,json=followingId,proto3" json:"following_id"`
...
type GetListFollowingRequest struct {
	...
	Search        *string                `protobuf:"bytes,4,opt,name=search,proto3,oneof" json:"search"` // Merged field for name, surname, Followingname
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type FollowingList struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Followings    []*User                `protobuf:"bytes,1,rep,name=Followings,proto3" json:"Followings"`
